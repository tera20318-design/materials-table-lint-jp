...
- Supports schema-based alias resolution, unit checks, required metadata, missing values, duplicate sample IDs, numeric parsing, and simple range checks.
- Writes human-readable summaries, JSON reports, and normalized CSV.
